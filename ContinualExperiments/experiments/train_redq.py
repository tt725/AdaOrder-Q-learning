...
import time
import sys
from diffalgos.algos.redq import REDQAgent
...
def redq(env_name, seed=0, epochs='mbpo', steps_per_epoch=1000,
    ...
    agent = REDQAgent(env_name, obs_dim, act_dim, act_limit, device,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algorithm_name', type=str, default='redq')
    ...
    redq(args.env, seed=args.seed, epochs=args.epochs,
             logger_kwargs=logger_kwargs,
         num_Q=args.num_Q, num_min=args.num_min,
         utd_ratio=args.utd_ratio, policy_update_delay=args.policy_update_delay)
