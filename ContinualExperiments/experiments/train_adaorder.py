...
import math
import sys
from diffalgos.algos.adaorder import AdaOrderAgent
...
def adaorder(env_name, seed=0, epochs='mbpo', steps_per_epoch=1000,
    ...
    agent = AdaOrderAgent(env_name, obs_dim, act_dim, act_limit, device,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algorithm_name', type=str, default='adaorder')
    ...
    adaorder(args.env, seed=args.seed, epochs=args.epochs,
