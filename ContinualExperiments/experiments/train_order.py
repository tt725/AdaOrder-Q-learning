...
import time
import sys
from diffalgos.algos.order import OrderAgent
...
def order(env_name, seed=0, epochs='mbpo', steps_per_epoch=1000,
             ...
             policy_update_delay=20, order_m=2, reseed_each_epoch=True
             ):
    ...
    agent = OrderAgent(env_name, obs_dim, act_dim, act_limit, device,
                 hidden_sizes, replay_size, batch_size,
                 lr, gamma, polyak,
                 alpha, auto_alpha, target_entropy,
                 start_steps, delay_update_steps,
                 utd_ratio, num_Q, order_m,
                 policy_update_delay)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algorithm_name', type=str, default='order')
    parser.add_argument('--data_dir', type=str, default='./data')
    parser.add_argument('--num_Q', type=int, default=3)
    parser.add_argument('--order_m', type=int, default=1)
    ...
    order(args.env, seed=args.seed, epochs=args.epochs,
             logger_kwargs=logger_kwargs,
         num_Q=args.num_Q,
         utd_ratio=args.utd_ratio,
         policy_update_delay=args.policy_update_delay, order_m=args.order_m)
