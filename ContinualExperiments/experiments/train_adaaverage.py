...
import math
import sys
from diffalgos.algos.adaaverage import AdaAverageAgent
...
def adaaverage(env_name, seed=0, epochs='mbpo', steps_per_epoch=1000,
    ...
    agent = AdaAverageAgent(env_name, obs_dim, act_dim, act_limit, device,
    ...
    for t in range(total_steps):
        agent.num_M = math.ceil(agent.num_C*(1-t/(total_steps)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algorithm_name', type=str, default='adaaverage')
    parser.add_argument('--data_dir', type=str, default='./data/')
    parser.add_argument('--num_C', type=int, default=3)
    ...
    adaaverage(args.env, seed=args.seed, epochs=args.epochs,
