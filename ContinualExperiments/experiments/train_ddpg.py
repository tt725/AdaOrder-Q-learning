...
import time
import sys
from diffalgos.algos.ddpg import DDPGAgent
...
def ddpgQ(env_name, seed=0, epochs='mbpo', steps_per_epoch=1000,
    ...
    agent = DDPGAgent(env_name, obs_dim, act_dim, act_limit, device,
...
if __name__ == '__main__':
    ...
    ddpgQ(args.env, seed=args.seed, epochs=args.epochs,
